...
"""
    ...
    def "Verify severities and CVSS #cve #imageDigest #component #severity #cvss"() {
        ...
        RHEL_IMAGE_DIGEST   | "python3" | "CVE-2026-4519" |
                VulnerabilitySeverity.IMPORTANT_VULNERABILITY_SEVERITY | 7.1 | false
        RHEL_IMAGE_DIGEST   | "python3" | "CVE-2026-4519" |
                VulnerabilitySeverity.IMPORTANT_VULNERABILITY_SEVERITY | 7.1 | true
